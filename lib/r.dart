...
class _R_Color {
  ...
  Color vip_product_name_main_text() => Color(0xff494dcf);
  Color vip_product_name_sub_text() => Color(0xffff8080);
  Color vip_product_unselected_bg() => Color(0x80ffffff);
  Color vip_product_unselected_border() => Color(0xffdddeec);
  Color vip_product_selected_bg() => Color(0xffe5e8fc);
  Color vip_product_selected_border() => Color(0xff494dcf);
  Color vip_product_new_in_gift_tag_bg() => Color(0xff6569ee);
  Color vip_product_new_in_gift_tag_text() => Color(0xffffffff);
  Color vip_product_extra_day_gift_tag_bg() => Color(0xfff1b517);
  Color vip_product_extra_day_gift_tag_text() => Color(0xffffffff);
